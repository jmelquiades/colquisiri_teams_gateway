...
# Tu backend (donde vive /n2sql/run)
...
# ⚡ CLAVE: alineamos tenant y scope en el adapter, igual que en los diagnósticos
...
async def _reply_md(context: TurnContext, title: str, cols: List[str], rows: List[Dict[str, Any]], limit: int = 10):
    # Confiamos el serviceUrl antes de responder
...
async def on_message(context: TurnContext):
    ...
    # DEMO de intent (ajústalo cuando quieras)
